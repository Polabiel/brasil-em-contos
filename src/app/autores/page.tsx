        ...
        >
          <Stack spacing={6} alignItems="center" textAlign="center">
            <Stack spacing={3}>
              ...
              >
                Conheça os grandes mestres da literatura brasileira que moldaram
                nossa identidade cultural através de suas obras imortais.
              </Typography>
            </Stack>
              ...
              <CardContent sx={{ p: { xs: 3, md: 4 } }}>
                <Stack spacing={3} alignItems="center">
                  ...
                  >
                    ...
                    encontrará aqui biografias completas, obras principais e
                    curiosidades sobre nossos autores.
                  </Typography>
                  <Typography
                    level="body-sm"
                    sx={{
