...
function getAuthorName(author: unknown, createdBy: unknown): string {
  ...
  if (createdBy && typeof createdBy === 'object' && 'name' in createdBy && typeof createdBy.name === 'string') {
...
export default function HeroSection() {
  const { data: featuredPosts, isLoading } = api.post.featured.useQuery(undefined, {
    retry: false,
            ...
            {isLoading ? (
              ...
              <>
                {[1, 2].map((index) => (
                  ...
                  >
                    <CardContent sx={{ p: 3 }}>
                      <Box sx={{ height: 16, bgcolor: 'var(--cv-textMuted20)', borderRadius: 4, mb: 2 }} />
                      <Box sx={{ height: 40, bgcolor: 'var(--cv-textMuted10)', borderRadius: 4, mb: 2 }} />
                      <Box sx={{ height: 12, width: '60%', bgcolor: 'var(--cv-textMuted20)', borderRadius: 4 }} />
                    </CardContent>
                  </Card>
                ))}
              </>
                  ...
                  >
                    ...
                    >
                      <CardContent sx={{ p: 3, height: '100%', display: 'flex', flexDirection: 'column' }}>
                        ...
                        >
                          {post.description ?? (post.content?.slice(0, 100) ? post.content.slice(0, 100) + '...' : '')}
                        </Typography>
              ...
              >
                <Stack spacing={2} alignItems="center" textAlign="center">
                  <Typography level="h4" sx={{ fontSize: '1.5rem' }}>📚</Typography>
                  <Typography level="title-md" sx={{ color: 'var(--cv-textMuted70)', fontSize: '0.9rem' }}>
                    Posts em destaque aparecerão aqui
                  </Typography>
                  <Typography level="body-sm" sx={{ color: 'var(--cv-textMuted50)', fontSize: '0.8rem' }}>
